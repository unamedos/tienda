...
<!-- jQuery-ui2 
<script src=public/plugins/jquery-ui2/jquery-ui.css"></script>-->
...
<!-- Toastr CSS -->
<link href="<?php echo base_url(); ?>public/plugins/jquery-toast-plugin/dist/jquery.toast.min.css" rel="stylesheet" type="text/css">
<!-- Ionicons -->
<link rel="stylesheet" href="<?php echo base_url(); ?>public/plugins/Ionicons/css/ionicons.min.css">
<!-- Theme style -->
...
<?php require_once(APPPATH . 'views/messages/message.php');  ?>