<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>category">Productos</a></li>
              ...
              <tbody>
                ...
                if (is_array($listado) || is_object($listado)) {
                  foreach ($listado as $row) {
                    $rutaVer = base_url() . "product/show?id=" . $row->id;
                    $rutaEdit = base_url() . "product/edit?id=" . $row->id;
                    $rutaEliminar = base_url() . "product/delete?id=" . $row->id;
